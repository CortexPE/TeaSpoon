...
class Main extends PluginBase {
	...
	public const TESTED_MIN_POCKETMINE_VERSION = "1.7dev-913"; // The minimum build this was tested working
	public const TESTED_MAX_POCKETMINE_VERSION = "1.7dev-920"; // The current build this was actually tested
